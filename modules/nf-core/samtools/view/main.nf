process SAMTOOLS_VIEW {
    ...
    args.contains("--output-fmt cram") ? "cram":
    input.getExtension()
    default_index_format = file_type == "bam" ? "csi":
    file_type == "cram" ? "crai": ""
    index = index_format ? "touch ${prefix}.${file_type}.${index_format}": args.contains("--write-index")
    ? "touch ${prefix}.${file_type}.${default_index_format}": ""
